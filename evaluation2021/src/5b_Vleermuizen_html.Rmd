...
Tabel \@ref(tab:MeetnKaraktVleermuizen1) geeft een overzicht van de karakteristieken van de amfibieënmeetnetten.
...
```{r figuurBezoekenVleermuizen, fig.height= 9, fig.width= 6.5,  fig.cap = str_c("Overzicht tijdstippen waarop tellingen werden uitgevoerd in ", year_evaluation) }
...
```{r vleermuis, fig.cap= "Getelde aantallen per bezoek (grijze punten) en gemiddelde getelde aantallen per bezoek (rode punten)"}
