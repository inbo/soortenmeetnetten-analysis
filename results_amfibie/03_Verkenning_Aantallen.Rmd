...
De in Tabel \@ref(tab:tabaantalsec) getoonde aantallen voor adulten en juvenielen komen van de fuiktellingen van het meetnet kamsalamander.
...
summary_year_sec %>% 
  ...
  select("Nederlandse naam" = soort_nl, "Wetenschappelijke naam" = soort_wet, "Levensstadium" = type,  Jaar = jaar, "Totaal" = aantal_tot, "Gemiddeld" = aantal_mean, "Locaties" = n_locaties_secundair, "Proportie (%)" = prop_aanwezig) %>%
  kable(caption = "Overzicht getelde aantallen voor de secundaire soorten (Totaal = totaal aantal, Gemiddeld = gemiddeld aantal per bezoek, Locaties = aantal getelde locaties met secundaire soorten, Proportie = proportie van de locaties waar de soort en het levensstadium werd waargenomen)",
      booktabs = TRUE,
      longtable = TRUE,
      align = "lllccccc") %>%
  kable_styling(bootstrap_options = c( "condensed"), 
