...
overzicht_locaties %>%
  ...
  addLayersControl(
    overlayGroups = c("Zoekgebied", "Locatie in meetnetten.be", "Referentiepunten"),
...
sublocaties_otter %>%
  ...
  st_write(dsn = "../output/inhaalslag_otter.gpkg", layer = "referentiepunten")

hoofdlocaties_otter %>%
  select(meetnet, locatie) %>%
  st_write(dsn = "../output/inhaalslag_otter.gpkg", layer = "gebieden")

zoekgebieden_otter %>%
  st_write(dsn = "../output/inhaalslag_otter.gpkg", layer = "zoekgebieden")
