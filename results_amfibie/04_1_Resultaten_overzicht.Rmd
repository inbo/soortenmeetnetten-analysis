...
verschillen_cyclus %>%
  ...
  rename("Nederlandse naam" = soort_nl, "Levensstadium" = levensstadium, "Meetcyclus 1" = meetcyclus_ref, "Meetcyclus 2" = meetcyclus, "Klasse" = klasse_output, "Verschil" = verschil_tbl) %>%
...
overzicht_trend_tabel <- trend_all %>%
  filter(soort_periode != "Vuursalamander_2018_2023") %>%
