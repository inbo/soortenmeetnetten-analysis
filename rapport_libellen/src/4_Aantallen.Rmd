...
In het tabblad 'Grafiek' tonen we het gemiddelde aantal getelde individuen per bezoek weer met 95% betrouwbaarheidsinterval.   

De tabel in het tablad 'Tabel' geeft een overzicht van het:
...
*Dit is een een grafiek voor alle soorten. Ook mogelijk om te tonen via een tabs met 1 grafiek per soort.*
...
summary_counts_type_primair <- summary_counts$details %>%
...
Tijdens het tellen van libellen wordt er onderscheidt gemaakt tussen het geslacht (mannelijk of M, vrouwelijk of F, onbekend of U), het levensstadium (imago, larvenhuidje) en de activiteit (ter plaatse, copula, eiafzettend). In onderstaande tabel, tonen we het gemiddelde getelde aantal:
