...
klasse_color <- c("++" = inbo.groen, "+" = inbo.groen, "--" = inbo.rood, "-" = inbo.rood, "?+" = inbo.grijsblauw, "?-" = inbo.grijsblauw, "?" = inbo.grijsblauw, "~" = inbo.geelgr, "+~" = inbo.groen, "-~" = inbo.rood, "R" = inbo.grijsblauw)
