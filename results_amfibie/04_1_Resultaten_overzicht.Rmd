...
```{r fighk1, fig.width = 9, fig.height = 5, fig.cap = "Proportie van de waterpartijen met aanwezigheid van vis en met een permanente waterkolom en 90 \\% betrouwbaarheidsinterval"}
...
vegetatie %>%
  ...
  geom_col() +
  geom_text(aes(label = n), position = position_stack(vjust = 0.5), color = "white", size = 2) +
