...
indexmodel_iid_rw1year_2018_2022 <- inla(formula = aantal ~  f(jaar_scaled, 
                                  model = "rw1", 
                                  hyper = list(theta = list(prior = "pc.prec", param = c(0.3, 0.05)))) + 
                                f(locatie, 
                                  model = "iid", 
...
results_waic_vuursalamander_2016_2022 <- bind_rows(
  get_waic(analyseset_vuursalamander, trendmodel_iid2) %>%
    mutate(model = "trendmodel"),
  get_waic(analyseset_vuursalamander, indexmodel_iid_rw1year) %>%
    mutate(model = "indexmodel"))

results_waic_vuursalamander_2018_2022 <- bind_rows(
  get_waic(analyseset_vuursalamander_2018_2022, trendmodel_iid2_2018_2022) %>%
    mutate(model = "trendmodel"),
  get_waic(analyseset_vuursalamander_2018_2022, indexmodel_iid_rw1year_2018_2022) %>%
    mutate(model = "indexmodel")
  )
```
