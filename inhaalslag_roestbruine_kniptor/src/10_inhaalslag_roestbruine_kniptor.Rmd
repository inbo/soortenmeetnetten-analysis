...
+ **afwezig - niet gedocumenteerd**: hok werd op inactief gezet, maar er is geen data beschikbaar voor dat hok. Het is dus onduidelijk waarom het hok op inactief werd gezet. Arno?
...
overzicht_locaties_inhaalslag <- locaties_roestbruine_kniptor %>%
  ...
  mutate(locatie_in_meetnetten = ifelse(is.na(locatie_in_meetnetten), TRUE, locatie_in_meetnetten),
         ...
         status = ifelse(aanwezig & !is.na(aanwezig), "aanwezig",
                         ifelse(is.na(aanwezig) & !is_active, "afwezig - niet gedocumenteerd",
...
Hieronder geven we een overzicht van alle onderzochte hokken uit de inhaalslag.
