...
```{r meboomkikker, fig.cap= str_c("Monitoringsinspanning voor het meetnet ", m)}
...
```{r vjboomkikker,  fig.width = 7, fig.cap= str_c("Jaarlijkse verschillen in aantallen t.o.v. referentiejaar (weergegeven in de figuur met R) met het 90\\% betrouwbaarheidsinterval voor de ", m, ".")}
...
size_bar <- 35 * 2 / (2023 - ref_jaar + 1)
size_bar2 <- 35 * 2 / (2023 - ref_jaar)
...
```{r vj2boomkikker, fig.width = 7, fig.height= 3.5, fig.cap= str_c("Verschillen in aantallen tussen opeenvolgende jaren met het 90\\% betrouwbaarheidsinterval voor de ", m, ".")}
...
```{r vmboomkikker, fig.width = 5, fig.cap= str_c("Verschillen in aantallen per meetcyclus t.o.v. referentie meetcyclus met het 90\\% betrouwbaarheidsinterval voor de ", m, ".")}
...
```{r vmoboomkikker, fig.width = 2.5, fig.cap= str_c("Voorkomen per meetcyclus met het 90\\% betrouwbaarheidsinterval voor de ", m, ".")}
...
```{r meknoflookpad, fig.cap= str_c("Monitoringsinspanning voor het meetnet ", m)}
...
```{r vjknoflookpad, fig.cap= str_c("Jaarlijkse verschillen in aantallen t.o.v. referentiejaar (weergegeven in de figuur met R) met het 90\\% betrouwbaarheidsinterval voor de ", m, ".")}
...
```{r vj2knoflookpad, fig.cap= str_c("Verschillen in aantallen tussen opeenvolgende jaren met het 90\\% betrouwbaarheidsinterval voor de ", m, ".")}
...
```{r mekamsalamander, fig.cap= str_c("Monitoringsinspanning voor het meetnet ", m)}
...
```{r vjkamsalamander, fig.width = 7, fig.cap= str_c("Jaarlijkse verschillen in aantallen t.o.v. referentiejaar (weergegeven in de figuur met R) met het 90\\% betrouwbaarheidsinterval voor de ", m, ".")}
...
```{r vj2kamsalamander, fig.width = 7, fig.height= 3.5, fig.cap= str_c("Verschillen in aantallen tussen opeenvolgende jaren met het 90\\% betrouwbaarheidsinterval voor de ", m, ".")}
...
```{r vmkamsalamander, fig.width = 5, fig.cap= str_c("Verschillen in aantallen per meetcyclus t.o.v. referentie meetcyclus met het 90\\% betrouwbaarheidsinterval voor de ", m, ".")}
...
```{r vmokamsalamander,  fig.width= 2.5, fig.cap= str_c("Voorkomen per meetcyclus met het 90\\% betrouwbaarheidsinterval voor de ", m, ".")}
...
```{r mevuursalamander, fig.cap= str_c("Monitoringsinspanning voor het meetnet ", m)}
...
```{r vjvuursalamander, fig.cap= str_c("Jaarlijkse verschillen in aantallen t.o.v. referentiejaar (weergegeven in de figuur met R) met het 90\\% betrouwbaarheidsinterval voor de ", m, ".")}
...
```{r vj2vuursalamander, fig.cap= str_c("Verschillen in aantallen tussen opeenvolgende jaren met het 90\\% betrouwbaarheidsinterval voor de ", m, ".")}
...
Sinds 2018 zijn de aantallen dus **stabiel**.
