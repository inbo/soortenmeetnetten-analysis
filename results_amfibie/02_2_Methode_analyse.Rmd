...
-   Bij boomkikker en kamsalamander zijn de locaties (poelen) vaak geclusterd en de aantallen per poel binnen zo een cluster zijn vaak gecorreleerd.
    Daarom voegen we ook een cluster-effect toe aan het model.

-   In sommige gevallen verschilt de zoekinspanning per locatie en deze zoekinspanning heeft een invloed op de getelde aantallen.
    ...
    Bij de fuiktellingen van kamsalamander gaat het om het aantal fuiken.
    Meestal worden er twee fuiken gebruikt, zoals het protocol voorschrijft, maar in sommige gevallen worden er ook meer of minder fuiken ingezet.
