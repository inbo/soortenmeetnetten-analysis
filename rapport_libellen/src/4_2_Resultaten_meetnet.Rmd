...
include_graphics("../fig/Bosbeekjuffer_klein.jpg")
```
...
include_graphics("../fig/speerwaterjuffer.jpg")
```
...
include_graphics("../fig/Maanwaterjuffer.jpg")
```
...
include_graphics("../fig/Variabele_waterjuffer.jpg")
```
## Meetnetkarakteristieken
...
include_graphics("../fig/Vroege_glazenmaker_klein.jpg")
```
## Meetnetkarakteristieken
...
include_graphics("../fig/Rivierrombout_larve.jpg")
```
...
```{r, fig.width= 7, fig.cap= str_c("Mannetje ", m, " (Foto: Erik Moonen)"), out.width = "75%"}
include_graphics("../fig/Gevlekte_witsnuitlibel_klein.jpg")
```
...
include_graphics("../fig/Kempense_heidelibel_klein.jpg")
```
