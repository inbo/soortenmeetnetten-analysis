...
```{r}
name_analysis_gebiedstelling <- "output/results/vlinders_imago_gebied_2022-03-28"
name_analysis_transecttelling <- "output/results/vlinders_imago_transect_2022-03-28"
name_analysis_eitelling <- "output/results/vlinders_eitelling_2022-03-28"
...
Daarom is het ook nuttig om periodes van drie jaar (die overeenkomen met een meetcyclus) met elkaar te vergelijken. Voor Heivlinder en Argusvlinder werden er al twee meetcycli afgerond (2016 - 2018 en 2019 - 2021) en kunnen we dus deze beide periodes vergelijken (Tabel \@ref(tab:tabelverschil3)). Het meetnet Oranje zandoogje ging in 2017 van start, waardoor de tweede cyclus afloopt in 2022 en we pas dan beide meetcycli kunnen vergelijken.
