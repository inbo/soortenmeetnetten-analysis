...
Door vervagingsregels worden de meetnetlocaties weergegeven in het centrum van het 5 x 5 km UTM-hok waarin de locatie is gelegen. Sommige UTM-hokken bevatten meerdere meetnetlocaties. Hoe donkerder de blauwe kleur van de punten, hoe meer meetnetlocaties. Elk punt heeft een label dat aangeeft hoeveel meetnetlocaties per meetnet het UTM-hok bevat. De label wordt getoond als je met de muis over de punten gaat. Je kan ook een of meerdere meetnetten selecteren via het selectievenster.
...
Twee mogelijkheden om te presenteren:

- optie 1: tab met aparte grafiek per meetnet
- optie 2: alle meetnetten in 1 figuur
