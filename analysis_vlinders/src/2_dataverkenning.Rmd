...
```{r}
aantallen_locaties <- analyseset_transect %>%
...
```{r}
analyseset_transecten_locations_weer <- analyseset_transect %>%
...
name_analyseset <- "analyseset_vlinders_eitelling"
versie <- "vlinders_eitelling_2025-11-04"
