...
summary_table %>% 
  ...
  filter(is_sample) %>%
  select("Nederlandse naam" = soort_nl, "Wetenschappelijke naam" = soort_wet, "Levensstadium" = type,  Jaar = periode, "Totaal" = aantal_tot, "Gemiddeld" = aantal_mean, "Locaties" = n_locaties, "Proportie (%)" = prop_aanwezig) %>%
