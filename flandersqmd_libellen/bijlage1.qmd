# Bijlage: beschrijving van de analyse {#sec-bijlage-1}
...
+ $b_{d}$ het effect van jaar $d$. Dit effect modelleert een tweede orde random walk.
...
Voor de meetnetten meet een driejaarlijkse meetcyclus (bosbeekjuffer, vroege glazenmaker en variabele waterjuffer) fitten we een model om de verschillen tussen de meetcycli te schatten.

Omdat deze meetnetten gebruik maken van transecttellingen, moeten het model ook rekening houden met de transectlengte. 
...
# Bijlage: Reproduceerbaarheid van de analyses {#sec-bijlage-r}
...
Meer specifiek gebeuren de analyses voor de libellenmeetnetten via de scripts in de folder [inbo/soortenmeetnetten-analysis/analysis_amfibien/source (commit 8043773)](https://github.com/inbo/soortenmeetnetten-analysis/tree/8043773448933ef1b875e734c5efd8c7cf1aa586/analysis_amfibieen/source).
