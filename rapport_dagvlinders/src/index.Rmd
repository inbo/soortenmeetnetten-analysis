...
We wensen in de eerste plaats alle vrijwilligers te bedanken voor de vele tellingen die ze hebben uitgevoerd voor de dagvlindermeetnetten. Wim Veraghtert willen we bedanken voor de coördinatie van het veldwerk. Frederic Piesschaert bedanken we voor de technische ondersteuning bij de invoer van de gegevens via meetnetten.be en de bevraging van de meetnetten-databank. We bedanken ook de (ex-)leden van de stuurgroep van het soortenmeetnettenproject: Bernard Van Elegem, Véronique Verbist, Samuel De Rycke, Koen Van Keer, Hannes Ledegen, Wouter Vanreusel, Marc Herremans, Maurice Hoffmann en Marc Pollet.
...
Dit rapport toont de eerste resultaten van de dagvlindermeetnetten voor de periode 2016 - 2010. In die periode zien we: 
