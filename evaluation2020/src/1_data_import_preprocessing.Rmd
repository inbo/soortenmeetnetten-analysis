...
locaties_metadata <- locaties %>%
  ...
  mutate(is_sample = ifelse(meetnet == "Kamsalamander" & locatie %in% c("Antitankgracht Haacht - Poel 15", "De Brand - Poel 6", "Kleine Struisbeekvallei - poel 2", "Vallei van de Mark - Poel 1"), TRUE, is_sample)) %>% #NOG AANPASSEN IN MEETNETTEN.BE
...
data_das <- read.csv2(file.path(path, "data_extern/das/meetnet_das_2016_2018.csv"), stringsAsFactors = FALSE)
