...
Voor Kamsalamander is 2020 een overgangsjaar tussen meetcyclus 1 (jaar 4 in 1ste meetcyclus) en meetcyclus 2 (jaar 1 in 2de meetcyclus). Alle getelde locaties worden daarom als nieuw getelde locaties beschouwd.
...
```{r figuurBezoekenamfibieen, fig.height= 6, fig.width= 6.5,  fig.cap = "Overzicht tijdstippen waarop tellingen werden uitgevoerd in 2020" }
...
Onderstaande tabel geeft een overzicht van de tellingen in de voldoende getelde extra locaties.
