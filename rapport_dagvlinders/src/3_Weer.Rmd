...
Het resultaat hiervan vind je in Figuur \@ref(fig:figtemp).
...
Op basis hiervan maken we voor elke maand een inschatting in hoeverre de totale neerslag afwijkt t.o.v. het gemiddelde in de periode 2016 - 2021. Dit doen we op dezelefde manier als voor temperatuur.
...
Het resultaat hiervan vind je in Figuur \@ref(fig:figrain).
