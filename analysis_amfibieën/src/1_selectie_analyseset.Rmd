...
Voor een aantal locaties geen transect gedefinieerd. Transectlengte gelijk stellen aan gemiddelde transectlengte.
...
mypath <- here(str_c("analysis_amfibieën/output/temp"))
