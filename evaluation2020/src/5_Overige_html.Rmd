...
```{r}
soortgroep_sel <- c("overige", "kevers", "spinnen")
```
...
In Tabel \@ref(tab:overzichtTellingenoverige3) evalueren we de doelen voor de meetcyclus. De tabel geeft volgende informatie: 
...
```{r figuurBezoekenoverige, fig.height= 9, fig.width= 6.5,  fig.cap = "Overzicht tijdstippen waarop tellingen werden uitgevoerd in 2018" }
