...
meetnetcharacteristics %>%
  ...
  select("Nederlandse naam" = soort_nl, "Wetenschappelijke naam" = soort_wet, Beleidsrelevantie = type_soort, "Type monitoring" = type, "Start monitoring" = opstartjaar) %>%
    unique() %>%
  kable(caption = "Overzicht van de amfibieën waarvoor een meetnet bestaat met onderscheid tussen Europees prioritaire (EPS) en Vlaams prioritaire soorten (VPS), en met het jaar waarin de monitoring werd opgestart",
        booktabs = TRUE,
        align = c("l", "l", "c", "l", "c"),
      row.names = FALSE) %>%
  kable_styling() %>%
