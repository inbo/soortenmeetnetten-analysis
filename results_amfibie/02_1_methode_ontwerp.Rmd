...
-   **Transecttelling vuursalamander**: Het aantal post-metamorfe vuursalamanders wordt geteld langs een transect van ongeveer 1 km.
...
-   **Telling larven en metamorfen** Larven van kamsalamander, boomkikker, poelkikker en vroedmeesterpad worden geteld met een schepnet.
    ...
    We noteren het aantal larven en metamorfen per soort en ook het aantal uitgevoerde schepbewegingen.
...
-   **Telling van gladde slang onder platen** In elk gebied worden er een vooropgesteld aantal artificiële platen gelegd waaronder gladde slangen zich gaan ophouden.
    Per plaat tellen we het aantal adulte en juveniele dieren tijdens geschikte weersomstandigheden, bij temperaturen tussen 17 en 22°C
...
Ook voor vuursalamander en gladde slang gebruiken we een gebied als locatie.
...
In het geval van een steekproef, zullen we een nieuwe steekproef trekken wanneer de verspreiding van de soort sterk wijzigt.
