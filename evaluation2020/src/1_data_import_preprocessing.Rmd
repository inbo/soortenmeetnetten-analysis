...
```{r}
aantallen_planten_bezoek_meetnetten <- get_counts_smp(species_group = "planten") %>%
...
aantallen_planten_extern <- read_vc(file = "processed/data_plantenmeetnetten_2020", root = fileman_up("soortenmeetnetten-data")) %>%
...
write.csv2(overzicht_alle_locaties_planten, "../output/plantenmeetnetten_locaties_2019_2020_versie2020-01-18.csv", row.names = FALSE)
