...
Meer specifiek gebeuren de analyses voor de amfibieënmeetnetten via de scripts in de folder [inbo/soortenmeetnetten-analysis/analysis_amfibien/source (commit 747da09)](https://github.com/inbo/soortenmeetnetten-analysis/tree/747da09e44f4d9d9bbcd6e0a3f784dc9c6f31682/analysis_amfibieen/source).

De analyseresultaten zijn terug te vinden in de folder [inbo/soortenmeetnetten-analysis/analysis_amfibien/output/results (commit 747da09)](https://github.com/inbo/soortenmeetnetten-analysis/tree/747da09e44f4d9d9bbcd6e0a3f784dc9c6f31682/analysis_amfibieen/output/results)
...
tabel_status_rugstreeppad %>%
  kbl(caption = "Overzicht van het voorkomen van de rugstreeppad (op basis van tellingen van adulten en eisnoeren) per meetnetlocatie en meetcyclus en overzicht van de meetnetlocaties die deel uitmaken van de analyse van de trend van het aantal roepkoren.",
      longtable = TRUE,
      booktabs = TRUE) %>%
