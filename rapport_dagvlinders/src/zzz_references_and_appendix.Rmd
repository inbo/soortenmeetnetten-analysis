...
# Bijlage: Reproduceerbaarheid van de analyses {#h:bijlager}

De analyses werden uitgevoerd via de programmeertaal R. De R-scripts staan onder versiebeheer via volgende GitHub repository: [inbo/soortenmeetnetten-analysis](https://github.com/inbo/soortenmeetnetten-analysis) en zijn publiek toegankelijk.
...
# Bijlage: Verkenning aantallen secundaire soorten {#h:bijlageo}
