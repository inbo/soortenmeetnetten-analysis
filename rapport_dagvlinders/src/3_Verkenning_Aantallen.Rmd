...
bscols(list(
          bscols(
            ...
            formatStyle(columns = c(1, 2, 3, 4, 5), fontSize = '9 pt')
        )
)
...
In Bijlage \@ref(h:bijlageo) geven we een overzicht van de gemiddelde getelde aantallen per jaar voor de algemenere secundaire soorten.  
