...
visits <- get_visits_smp(species_group = species_group, file = "raw/bezoeken_20231213") %>%
...
counts_all <- get_counts_smp(species_group = species_group, file = "raw/aantallen_20231213")
...
counts_sublocation_selection <- visits_selection %>%
  select(soortgroep, meetnet, protocol, generatie, locatie, jaar, datum, doy, doy_scaled, doy_min, doy_max, doy_mid,  visit_id, n_obs, voor_analyse, is_active, is_sample, bezoek_status, notes) %>%
